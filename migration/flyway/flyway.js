module.exports = function () {
	return {
		flywayArgs: {
			...
			url: `jdbc:postgresql://cc-client-operations-program-configuration-dev.cluster-cukimq938igp.us-east-1.rds.amazonaws.com:5432/postgres?ssl=true&sslmode=verify-ca`,
			sslcert:"./../../cert/us-east-1-bundle.crt",
