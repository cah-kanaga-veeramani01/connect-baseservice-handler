CREATE OR REPLACE FUNCTION MAP_LEGACY_TIP_TO_SERVICE_USERID_TRIGGER() RETURNS TRIGGER AS $$
...
CREATE TRIGGER MAP_LEGACY_TIP_TO_SERVICE_USERID_TRIGGER
AFTER
INSERT ON "attunityservice"."TIPDetailRuleOverview" FOR EACH ROW EXECUTE PROCEDURE MAP_LEGACY_TIP_TO_SERVICE_USERID_TRIGGER();